...
- Conducted reconnaissance, brute force, and exploit simulations using Metasploit originating from the attacker VM, targeting the Windows agent.
- Simulated an attacker gaining administrator permissions and downgrading the security of Windows client's SMB component.
